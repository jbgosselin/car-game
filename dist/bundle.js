	  ...
	  var Race = (function () {
	    ...
	    _createClass(Race, [{
	      ...
	      value: function create() {
	        ...
	        for (var n = 0; n < this.game.world.width; n += 32) {
	      ...
	      value: function update() {
	        ...
	        if (this.gameOver) {
	          ...
	          this.game.physics.arcade.collide(this.player, this.persons, function (pl, per) {
	            console.log("Bravo !");
	            _this.score += 10;
	            _this.text.setText("SCORE: " + _this.score);
	            per.destroy();
	          });
	          this.game.physics.arcade.collide(this.player, this.ennemies, function (p, e) {
	            console.log("Collide !");
	            _this.gameOver = true;
	            _this.game.add.text(0, 50, "GAME OVER !");
	            _.forEach(_this.ground.children, function (g) {
	              g.body.velocity.x = 0;
	            });
	            _.forEach(_this.ennemies.children, function (e) {
	              e.body.velocity.x = 0;
	            });
	          ...
	          if (this.timer <= 0) {
	            if (Math.random() <= this.chancePerson) {
	              var person = this.persons.create(this.game.world.width + 10, this.game.world.height - 32 - 48, "girl");
	              person.body.velocity.x = this.speed;
	              person.animations.add("normal", [0, 1, 2, 3, 4], 20, true);
	              person.animations.play("normal");
	            } else {
	              var ennemy = this.ennemies.create(this.game.world.width + 10, this.game.world.height - 32 - 46, "mecha");
	      ...
	      key: "destroyAndGenerateGround",
	      value: function destroyAndGenerateGround() {
	        ...
	        while (last !== undefined && last.body.position.x < this.game.world.width) {
	          var part = this.ground.create(last.body.position.x + last.body.width, this.game.world.height - 32, "ground-s", 10);
	          part.scale.setTo(2, 2);
	          part.body.velocity.x = this.speed;
	          part.body.immovable = true;
